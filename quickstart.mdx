...
Configure your Registry license, PostgreSQL, Valkey and hash-chain secret, then
run the start command printed by the installer. The dashboard and Web API are
deployed separately. See the
