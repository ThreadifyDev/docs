...
conn, err := threadify.Connect(ctx, "your-api-key", 
    ...
    threadify.WithEngineURL("http://localhost:8081"),
...
Notifications use explicit acknowledgements and can be redelivered. Make handlers
idempotent, especially when they trigger external actions. Scaling consumers does
not provide exactly-once execution of your application code.
