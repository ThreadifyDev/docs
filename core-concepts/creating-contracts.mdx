...
<Info>
Contracts are created and managed via the **Threadify UI**, not in your application code. Once created, you reference them by name when starting threads in your SDK.
</Info>
